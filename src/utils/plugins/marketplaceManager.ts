 ...
 *
 * Reads the configuration file at ~/.fast/plugins/known_marketplaces.json
 ...
 *
 * Writes the configuration to ~/.fast/plugins/known_marketplaces.json,
 ...
 * The configuration is saved to ~/.fast/plugins/known_marketplaces.json.
 *
    ...
    if (
      ...
      throw new Error(
        `Marketplace "${name}" has a relative source path (${entry.source.path}) ` +
          ...
          `Fast Code version. Run 'claude marketplace remove ${name}' and ` +
