...
function isPathAllowed(
  ...
  // and internal editable paths live under ~/.fast/ — matching the ordering in
      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, Fast Code may only access files in the allowed working directories for this session: ${dirListStr}.`
