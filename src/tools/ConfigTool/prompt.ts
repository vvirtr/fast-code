...
export const DESCRIPTION = 'Get or set Fast Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Fast Code configuration settings.

  View or change Fast Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.fast.json)
${globalSettings.join('\n')}
