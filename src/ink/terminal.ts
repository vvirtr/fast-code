...
// [fast-code] Cache result — terminal capabilities don't change mid-session
let _progressReportingCached: boolean | undefined
const _isProgressReportingAvailable = (): boolean => {
  return (_progressReportingCached ??= isProgressReportingAvailable())
}
export { _isProgressReportingAvailable as isProgressReportingAvailableCached }
