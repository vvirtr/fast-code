...
type TrackedTool = {
  ...
  /** Pre-parsed tool input from addTool()'s safeParse, avoids re-parsing in checkPermissionsAndCallTool */
  parsedInput?: { [key: string]: unknown }
...
export class StreamingToolExecutor {
  ...
  addTool(block: ToolUseBlock, assistantMessage: AssistantMessage): void {
    ...
    this.tools.push({
      ...
      status: 'queued',
      isConcurrencySafe,
      parsedInput: parsedInput.success ? parsedInput.data : undefined,
      pendingProgress: [],
    })
