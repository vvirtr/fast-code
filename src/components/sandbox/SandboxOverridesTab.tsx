...
function OverridesSelect(t0) {
  ...
  if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
    t13 = <Box flexDirection="column" marginTop={1} gap={1}>{t11}{t12}<Text dimColor={true}>Learn more:{" "}<Link url="https://github.com/vvirtr/fast-code">github.com/vvirtr/fast-code</Link></Text></Box>;
    $[22] = t13;
  } else {
    t13 = $[22];
  }
