...
function SandboxModeTab(t0) {
  ...
  if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box flexDirection="column" marginTop={1} gap={1}>{t5}<Text dimColor={true}>Learn more:{" "}<Link url="https://github.com/vvirtr/fast-code">github.com/vvirtr/fast-code</Link></Text></Box>;
    $[12] = t6;
  } else {
    t6 = $[12];
  }
