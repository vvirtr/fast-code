...
function PermissionRulesTab(t0) {
  ...
  if ($[0] !== t0) {
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
      t8 = {
        allow: "Fast Code won't ask before using allowed tools.",
        ask: "Fast Code will always ask for confirmation before using these tools.",
        deny: "Fast Code will always reject requests to use denied tools."
      };
      $[10] = t8;
    } else {
      t8 = $[10];
...
export function PermissionRuleList(t0) {
  ...
  if ($[89] === Symbol.for("react.memo_cache_sentinel")) {
    t28 = <Text>Fast Code can read files in the workspace, and make edits when auto-accept edits is on.</Text>;
    $[89] = t28;
  } else {
    t28 = $[89];
  }
