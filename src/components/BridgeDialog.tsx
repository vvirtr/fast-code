...
// [fast-code] Lazy-load qrcode (57KB) — only used when BridgeDialog renders
let _qrToString: typeof import('qrcode').toString | undefined
async function getQrToString() {
  if (!_qrToString) {
    const mod = await import('qrcode')
    _qrToString = mod.toString
  }
  return _qrToString
}
...
export function BridgeDialog(t0) {
  ...
  if ($[3] !== displayUrl || $[4] !== showQR) {
    t4 = () => {
      ...
      getQrToString().then(fn => fn(displayUrl, {
        type: "utf8",
