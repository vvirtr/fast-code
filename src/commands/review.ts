...
const CCR_TERMS_URL = 'https://github.com/vvirtr/fast-code'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Fast Code on the web. See ${CCR_TERMS_URL}`,
